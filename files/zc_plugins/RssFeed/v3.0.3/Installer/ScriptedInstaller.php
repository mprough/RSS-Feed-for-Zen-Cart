...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        ...
        $rows = [
            ['Installed version', 'RSS_FEED_VERSION', '3.0.3', 'Installed RSS Feed version.', 0, "zen_cfg_select_option(array('3.0.3'),"],
        ...
        $this->executeInstallerSql("UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '3.0.3', set_function = 'zen_cfg_select_option(array(\\'3.0.3\\'),' WHERE configuration_key = 'RSS_FEED_VERSION'");
