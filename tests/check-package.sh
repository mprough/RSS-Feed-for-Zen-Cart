...
version_root="$root/files/zc_plugins/RssFeed/v3.0.3"
...
grep -q "'pluginVersion' => 'v3.0.3'" "$version_root/manifest.php"
grep -q "public string \$version = '3.0.3'" "$version_root/Installer/ScriptedInstaller.php"
grep -q "RSS_FEED_VERSION', '3.0.3'" "$version_root/Installer/ScriptedInstaller.php"
